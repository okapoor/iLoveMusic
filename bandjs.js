...
var artistName="";
  ...
  function searchBandsInTown(artistInput) {
    ...
    success:function(response) {
      ...
      artist.append('<a href="#"><img class="img-responsive image" data-toggle="modal" data-target="#imageModal" src=' + response.thumb_url + '></img></a>');
      artist.append('<br>')
      artist.append('<a href="#" id="more">Read more about the artist</a>');
      $(".list").append(artist);
    ...
    success: function (data) {
      ...
      if (article===unavailable){$('#article').html("Sorry, the article you are looking for is not available")}
      }
    });
